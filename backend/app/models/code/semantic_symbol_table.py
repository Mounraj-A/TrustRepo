...
class SymbolEntry(BaseModel):
    ...
    # List of qualnames that reference this symbol
...
class SemanticSymbolTable(BaseModel):
    ...
    def add_reference(self, target_qualname: str,
                      source_qualname: str) -> bool:
        ...
        if target_qualname in self.symbols:
            if source_qualname not in self.symbols[target_qualname].references:
                self.symbols[target_qualname].references.append(
                    source_qualname)
            return True
        return False
