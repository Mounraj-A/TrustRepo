...
class EvidenceRankingAgent(BaseAgent):
    ...
    def process(self, message: AgentMessage) -> AgentMessage:
        ...
        # Deserialize evidence chains (if they are passed as dicts in payload or use message.evidence)
        ...
        self._log(message, f"Ranked {len(ranked_chains)} evidence chains. Top score: {scored_chains[0][0] if scored_chains else 0.0}")
